...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1M)(templateObject_2$o || (templateObject_2$o = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
styled__default['default'](Icon$j)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Icon$i = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M2.75 0.952381C2.75 0.4264 3.16041 0 3.66667 0H11.9167C12.4229 0 12.8333 0.4264 12.8333 0.952381V1.90476H11.9167L13.75 7.61905H2.75L3.66667 1.90476H2.75V0.952381ZM5.5 1.90476L4.79191 6.66667H11.603L10.0833 1.90476H5.5Z" }),
        React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M1.8335 8.57152C1.8335 8.04552 2.24391 7.61914 2.75016 7.61914H13.7502L18.5926 8.3379C19.4958 8.4719 20.1667 9.27562 20.1667 10.2235V12.6249C19.7367 12.4669 19.2739 12.381 18.7918 12.381C16.6686 12.381 14.92 14.0477 14.692 16.1906H10.8408C10.945 15.732 11.0002 15.2537 11.0002 14.762C11.0002 11.343 8.33253 8.57152 5.04183 8.57152C3.86058 8.57152 2.7596 8.92866 1.8335 9.54466V8.57152Z" }),
        React__default['default'].createElement("path", { opacity: "0.48", "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M5.04167 20.0001C7.82611 20.0001 10.0833 17.655 10.0833 14.762C10.0833 11.8691 7.82611 9.52393 5.04167 9.52393C2.25723 9.52393 0 11.8691 0 14.762C0 17.655 2.25723 20.0001 5.04167 20.0001Z" }),
        React__default['default'].createElement("path", { opacity: "0.48", "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M18.7918 20.0002C20.5637 20.0002 22.0002 18.5078 22.0002 16.6668C22.0002 14.8259 20.5637 13.3335 18.7918 13.3335C17.0199 13.3335 15.5835 14.8259 15.5835 16.6668C15.5835 18.5078 17.0199 20.0002 18.7918 20.0002Z" })));
};
...
var Icon$a = function (props) {
    return (React__default['default'].createElement("svg", __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "M8.3 11.7v-.925c0-.358-.267-.533-.592-.391l-4.175 1.8c-.658.283-1.191-.067-1.191-.775v-1.1c0-.567.425-1.225.95-1.442l4.75-2.042a.487.487 0 0 0 .25-.391v-2.55c0-.8.591-1.759 1.3-2.125a.9.9 0 0 1 .8 0c.716.366 1.308 1.316 1.308 2.116v2.55c0 .15.117.325.25.392l.867.367L8.3 11.7Z" }),
        React__default['default'].createElement("path", { opacity: 0.4, d: "M17.659 10.309v1.1c0 .708-.534 1.058-1.192.775l-4.175-1.8c-.333-.134-.592.033-.592.391V13.2c0 .192.109.467.25.6l1.934 1.942c.2.2.291.6.2.875l-.375 1.133a.852.852 0 0 1-1.184.492l-1.983-1.667a.866.866 0 0 0-1.092 0l-1.983 1.667A.826.826 0 0 1 6.3 17.75l-.375-1.133c-.091-.283 0-.675.2-.875L8.06 13.8a.986.986 0 0 0 .241-.6v-1.5l4.517-4.516 3.892 1.675c.525.225.95.883.95 1.45Z" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Arborswap home page" }, isPushed ? React__default['default'].createElement(LogoWithText, { className: "desktop-icon" }) : React__default['default'].createElement(Icon$1k, { className: "mobile-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Arborswap home page" }, isPushed ? React__default['default'].createElement(LogoWithText, { className: "desktop-icon" }) : React__default['default'].createElement(Icon$1k, { className: "mobile-icon" })))));
};
